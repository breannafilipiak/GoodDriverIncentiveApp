"""
Django settings for DriverIncentive project.
...
SECRET_KEY = 'django-insecure-dq_64(pl4ygfee@y+ks!m%szfv13)#ss2b8kgvy6-n#p!i0(8e'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'catalog.views.categories',
            ],
        },
    },
]

WSGI_APPLICATION = 'DriverIncentive.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = '4910djangotestemail@gmail.com'
EMAIL_HOST_PASSWORD = 'txqncbupueapdsxy'